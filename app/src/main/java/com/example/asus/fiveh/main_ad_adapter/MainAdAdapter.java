...
public class MainAdAdapter extends RecyclerView.Adapter<MainAdViewHolder> {
    ...
    Context context;
    public static final int NUMBER_OF_ADS = 50;
    ...
    @Override
    public MainAdViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
//        String text = mData.get(position);
        holder.mEditText.setText(R.string.AD_TITLE_FIXED);
